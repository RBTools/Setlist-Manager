...
namespace SetlistManager
{
    public partial class DifficultySelector : Form
    {
        ...
        public DifficultySelector(Point start, int startingDiff)
        {
            ...
            try
            {
                diffNoPart.Image = tools.LoadImage(Application.StartupPath + "\\res\\nopart.png");
                diff0.Image = tools.LoadImage(Application.StartupPath + "\\res\\diff0.png");
                diff1.Image = tools.LoadImage(Application.StartupPath + "\\res\\diff1.png");
                diff2.Image = tools.LoadImage(Application.StartupPath + "\\res\\diff2.png");
                diff3.Image = tools.LoadImage(Application.StartupPath + "\\res\\diff3.png");
                diff4.Image = tools.LoadImage(Application.StartupPath + "\\res\\diff4.png");
                diff5.Image = tools.LoadImage(Application.StartupPath + "\\res\\diff5.png");
                diff6.Image = tools.LoadImage(Application.StartupPath + "\\res\\diff6.png");
            }
            catch
            {
